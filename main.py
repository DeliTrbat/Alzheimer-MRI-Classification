...
def run_all_models_and_save_results():
    ...
    for activation_type in activation_types:
        ...
        with open('./results/simple_model_activation_{0}_epochs_{1}.txt'.format(activation_type, EPOCHS), 'w') as f:
            ...
            f.write("\t-> Accuracy: {0}\n".format(str(simple_model.history.history['accuracy'])))
            f.write("\t-> Loss: {0}\n".format(str(simple_model.history.history['loss'])))
            f.write("\t-> Validation accuracy: {0}\n".format(str(simple_model.history.history['val_accuracy'])))
            f.write("\t-> Validation loss: {0}\n".format(str(simple_model.history.history['val_loss'])))
    ...
    for activation_type in activation_types:
        ...
        with open('./results/custom_model_activation_{0}_epochs_{1}.txt'.format(activation_type, EPOCHS), 'w') as f:
            f.write("Activation type: {0}\n".format(activation_type))
            f.write("\t-> Accuracy: {0}\n".format(str(custom_model.history.history['accuracy'])))
            f.write("\t-> Loss: {0}\n".format(str(custom_model.history.history['loss'])))
            f.write("\t-> Validation accuracy: {0}\n".format(str(custom_model.history.history['val_accuracy'])))
            f.write("\t-> Validation loss: {0}\n".format(str(custom_model.history.history['val_loss'])))
    ...
    try:
        ...
        with open('./results/vgg16.txt', 'w') as f:
            f.write("\t-> Accuracy: {0}\n".format(str(vgg16.history.history['accuracy'])))
            f.write("\t-> Loss: {0}\n".format(str(vgg16.history.history['loss'])))
            f.write("\t-> Validation accuracy: {0}\n".format(str(vgg16.history.history['val_accuracy'])))
            f.write("\t-> Validation loss: {0}\n".format(str(vgg16.history.history['val_loss'])))
    except Exception:
    ...
    try:
        ...
        with open('./results/inception_v3.txt', 'w') as f:
            f.write("\t-> Accuracy: {0}\n".format(str(inception_v3.history.history['accuracy'])))
            f.write("\t-> Loss: {0}\n".format(str(inception_v3.history.history['loss'])))
            f.write("\t-> Validation accuracy: {0}\n".format(str(inception_v3.history.history['val_accuracy'])))
            f.write("\t-> Validation loss: {0}\n".format(str(inception_v3.history.history['val_loss'])))
    except Exception:
    ...
    try:
        ...
        with open('./results/resnet50.txt', 'w') as f:
            f.write("\t-> Accuracy: {0}\n".format(str(resnet50.history.history['accuracy'])))
            f.write("\t-> Loss: {0}\n".format(str(resnet50.history.history['loss'])))
            f.write("\t-> Validation accuracy: {0}\n".format(str(resnet50.history.history['val_accuracy'])))
            f.write("\t-> Validation loss: {0}\n".format(str(resnet50.history.history['val_loss'])))
    except Exception:
